...
def _parse_node(node_data: dict) -> dict:
    ...
    route_assembly_type = RouteAssemblyType(is_predicted=is_predicted, is_evidence=is_evidence)
...
def _parse_edge(edge_data: dict) -> dict:
    ...
    is_predicted = any(edge_data.get(key) for key in predicted_keys) or edge_data.get("is_predicted", False)
    ...
    edge_data["route_assembly_type"] = RouteAssemblyType(is_predicted=is_predicted, is_evidence=is_evidence)
